...
cpn.add_dataset(
    ...
    n_files=175,
    n_events=115297314.0, # this n_events is the gensumwt
    aux={'n_events': 173189950} # n_events in aux is the nEvents produced
)
...
cpn.add_dataset(
    ...
    n_files=28,
    n_events=31651962.0, # this n_events is the gensumwt
    aux={'n_events': 39627426} # n_events in aux is the nEvents produced
)
...
cpn.add_dataset(
    ...
    n_files=54,
    n_events=26576552.0, # this n_events is the gensumwt
    aux={'n_events': 56680878} # n_events in aux is the nEvents produced
)
...
cpn.add_dataset(
    ...
    n_files=128,
    n_events=32763798.0, # this n_events is the gensumwt
    aux={'n_events': 107747888} # n_events in aux is the nEvents produced
)